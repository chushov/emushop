    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='Описания пока нет...', verbose_name='Описание')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новый заказ'), ('progress', 'Заказ в обработке'), ('is_ready', 'Заказ готов'), ('completed', 'Заказ получен покупателем')], default='STATUS_NEW', max_length=100, verbose_name='Статус заказа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('members', models.ManyToManyField(to='musicshop.Member', verbose_name='Участник')),
            ],
            options={
